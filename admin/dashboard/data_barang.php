                ...
                <form action="proses_data_barang.php?proses=insert" method="POST">
                    ...
                    <div class="form-group mt-3 mb-2">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            ...
                            <option value="BTHP">Tidak Habis Pakai</option>
                        </select>
                    </div>
                    <div class="form-group mt-3 mb-2">
                ...
                <div class="modal-body">
                    <form action="proses_data_barang.php?proses=update" method="POST">
                        ...
                        <div class="form-group mt-3 mb-2">
                            ...
                            <select name="kategori" id="kategori" class="form-control">
                                <option value="BTHP" <?= ($row['kategori'] == 'BTHP') ? 'selected' : '' ?>>BTHP</option>
                                <option value="BHP" <?= ($row['kategori'] == 'BHP') ? 'selected' : '' ?>>BHP</option>
                            </select>
                        </div>
                        <div class="form-group mt-3 mb-2">
                            <label for="stock">Stock Barang:</label>
